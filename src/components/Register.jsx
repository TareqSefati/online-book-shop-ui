...
export default function Register() {
    ...
    const handleRegister = (event)=>{
        ...
        .then(async (result)=>{
			...
			await saveUserInDb(result.user.uid, email, password, name, phone, address, displayUrl);
	...
	const saveUserInDb = async (uid, email, password, name, phone, address, displayUrl)=>{
